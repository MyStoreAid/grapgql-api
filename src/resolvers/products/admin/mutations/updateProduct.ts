...
export default async function updateProduct (parent: any, args: Product, context: any): Promise<Product> | never{
    ...
    return await ProductModel.updateOne(context.prisma.products, productId, data)
}
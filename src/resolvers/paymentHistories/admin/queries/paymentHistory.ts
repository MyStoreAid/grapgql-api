...
export default async function paymentHistory (parent: any, args: DeletePaymentHistoryArgs): Promise<PaymentHistory> | never {
    ...
    try {
        ...
        if (existingBranch) {
            ...
            const paymentHistory: PaymentHistory = await PaymentHistoryModel.findOneForeignKey(paymentHistoryId, include);

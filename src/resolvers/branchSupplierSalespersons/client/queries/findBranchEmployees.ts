...
export default async function findBranchEmployees (parent: any, args: findBranchEmployeeArgs, context: any): Promise<BranchSupplierSalesperson[]> {
    ...
    return await BranchSupplierSalespersonModel.findManyForeignKey(context.prisma.branch_supplier_salespersons, data);
}
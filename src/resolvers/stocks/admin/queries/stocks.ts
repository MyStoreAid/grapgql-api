import { FindStockArgs } from "resolvers/stocks/types";
...
export default async function stocks(parent: any, args: FindStockArgs): Promise<any> | never {
    ...
    try{
        ...
        if (existingUserBranch){
            ...
            let branchProducts: any = await Model.queryRaw(query);
            const bProducts: Array<BranchProduct> = branchProducts.rows;
        }
        else {
